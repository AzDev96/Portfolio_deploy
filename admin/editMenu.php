...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 alert alert-secondary">Изменить Меню</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 col-sm-6 col-md-3">
                    ...
                    <form action="./edit-Menu.php?id=<?= $task['id'] ?>" method="post">
                        <div class="form-outline">
                            <input type="text" value="<?= $task['title'] ?>" name="title" id="title_menu"
                                class="form-control" />
                        </div>
